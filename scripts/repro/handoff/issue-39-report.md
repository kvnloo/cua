...
| --- | --- | --- | --- | --- |
| deterministic fast path | `caller_route.py`, `task_battery.py`, `transfer_probe.py` | one executable candidate | routing, a task battery, and the transfer probe | recipe-local |
