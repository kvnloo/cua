...
Missing prerequisite: pinned driver commit `c5ee191c02b11448ffefcc38b78b064a87d8ef23` is not an installed release. The installed release is `cua-driver 0.28.2`. The daemon is not running. See `scripts/repro/handoff/linux-host-probe.txt`.
