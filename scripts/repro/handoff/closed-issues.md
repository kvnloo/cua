...
Issue 71's caller table is `scripts/repro/handoff/issue-71-decision.md`. It does not add a public field.

The macOS trace comment is from will-bogusz, head `fb7841be7`, Calculator, and it includes AX walk counts. This host did not run that trace.
